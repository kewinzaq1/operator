...
Rails.application.configure do
  ...
  # SSL is configured below from environment so Render health checks can hit /up.
  ...
  config.hosts << ENV["APP_HOST"].to_s.split(":").first if ENV["APP_HOST"].present?
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch("APP_HOST", ENV["RENDER_EXTERNAL_HOSTNAME"] || "example.com") }
